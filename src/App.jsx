...
function MarketBar() {
  ...
  return (
    <div style={{background:'#00e5ff',minHeight:'40px',marginTop:'60px',padding:'.6rem 2rem',display:'flex',alignItems:'center',justifyContent:'center',gap:'3rem',flexWrap:'wrap',fontFamily:'monospace',fontSize:'.7rem',fontWeight:'bold',letterSpacing:'.1em',color:'#000'}}>
