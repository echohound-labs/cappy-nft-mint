    ...
    try {
      ...
      const fulfillIx = new TransactionInstruction({
        keys: [
          ...
          // ── member master edition (LAST — matches FulfillMint struct) ──
          { pubkey: PublicKey.findProgramAddressSync([Buffer.from('metadata'), METADATA_PROGRAM.toBuffer(), nftMint.toBuffer(), Buffer.from('edition')], METADATA_PROGRAM)[0], isSigner: false, isWritable: true },
        ],
        programId: CAPY_PROGRAM,
        data: fulfillDiscrim,
      });
